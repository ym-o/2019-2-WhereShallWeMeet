...
app.post('/info', function(req, res) {
  ...
  // console.log(names);
  connection.query('insert into test(meeting,day,attendees) values(?,?,?)', [body.meeting, body.date, names],
    function(error, result) {
      if (error) {
        ...
        res.render('midmap',{name:body.name,address:body.address});
        //res.redirect('/mid');
      }
    });
});
